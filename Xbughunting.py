...
os.system('clear')
os.system('clear')
os.system('mkdir ~/Xbughunting')
os.system('mkdir ~/Xbughunting/info')
os.system('mkdir ~/Xbughunting/mapp')
os.system('mkdir ~/Xbughunting/disc')
os.system('mkdir ~/Xbughunting/expt')
os.system('mkdir ~/Xbughunting/repo')
os.system('mkdir ~/Xbughunting/hacking')
os.system("rm ~/Xbughunting/update.sh")
os.system('clear')
os.system('clear')
...
\033[0m
   ...
   [2] - Mapping                    [about] - About The Xbughunting 
   [3] - Discovery                 [whoami] - Your IP and Location 
   [4] - Exploitation                [hacking] - Tools for Hacking
   [5] - P0Cs & Reporting            [exit] - Exit The Xbughunting  
 """)
...
def info():
    ...
    print(bughunterlogo)
    print("""
    Information Gathering | https://github.com/Whomrx666/Xbughunting
    ----------------------------------------------------------------
...
def mapping():
    ...
    print(bughunterlogo)
    print("""
    Mapping | https://github.com/Whomrx666/Xbughunting
    ----------------------------------------------------------------
...
def discovery():
    ...
    print(bughunterlogo)
    print("""
    Discovery | https://github.com/Whomrx666/Xbughunting
    ----------------------------------------------------------------
...
def exploit():
    ...
    print(bughunterlogo)
    print("""
    Exploitation | https://github.com/Whomrx666/Xbughunting
    -------------------------------------------------------------------------------------------
...
def reporting():
    ...
    print(bughunterlogo)
    print("""
    PoCs & Reporting | https://github.com/Whomrx666/Xbughunting
    ----------------------------------------------------------------
...
def hacking():
    ...
    print(bughunterlogo)
    print("""
    Tools for Hacking | https://github.com/Whomrx666/Xbughunting
    ----------------------------------------------------------------
    ...
    """)
    print("   [99] - Return to Main Menu \n")
    choicehacking = raw_input("   Xbughunting~# ")
    if choicehacking == "1":
        clearScr()
        hacktronian()
    if choicehacking == "2":
...
---------------------------------------------------------------------
    Follow Me : https://github.com/Whomrx666
 
    Blog      :  whomrxhackers.blogspot.com
    Github    :  https://github.com/Whomrx666 
    YouTube   :  https://youtube.com/@whomrx666
    Telegram   :  https://t.me/@Whomr_X
    Tiktok :  https://www.tiktok.com/@whomr.x
---------------------------------------------------------------------
    [!] Thanks for Using This Tool :) [+] peace for me (Mr.X) [+]
---------------------------------------------------------------------
    """)
